...
class ProfileView(APIView):
    ...
    def get_addresses(self, request):
        ...
        try:
            ...
            return Response({'addresses': addresses_list}, status=status.
            HTTP_200_OK)
    ...
    def get_service_history(self, request):
        """ Get the service history for the user.
        RETURNS:
            A response object containing the service history data matching MyServiceHistoryProps interface
            {
                "service_history": [
                    {
                        "id": "uuid-string",
                        "booking_date": "2024-01-01T10:00:00Z",
                        "appointment_date": "2024-01-02T14:00:00Z",
                        "service_type": "Service Type Name",
                        "valet_type": "Valet Type Name",
                        "vehicle_reg": "ABC123",
                        "address": {
                            "id": "address-id",
                            "address": "123 Main St",
        ...
        try:
            ...
            for appointment in appointments:
                ...
                service_history_item = {
                    ...
                    'valet_type': appointment.valet_type.name,
                    'vehicle_reg': appointment.vehicle.licence,  # Using licence field from Vehicles model
                    'address': {
                        'id': str(appointment.address.id),
                    ...
                    'detailer': {
                        ...
                        'image': appointment.detailer.image.url if appointment.detailer.image else None
                    },
